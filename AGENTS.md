...
- There is no newer active implementation plan after `docs/plans/3-2-quick-provider-switching.md`; remaining follow-up questions live in `docs/todo.md` backlog.
